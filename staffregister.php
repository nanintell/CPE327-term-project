...
<body>
    ...
    <!--We are hiring picture-->
    <div class=picstyle>
        <img src="picture/OBDPS10.png" alt="" width=400px;>
    </div>
    <!--Title-->
    <div class="container-fluid">
        <div class="row">
                ...
                <form action="staffinsert.php" method="POST">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="Name" placeholder="FirstName Lastname" name="Name" required>
                        </div>
                        <!--birthday date input-->
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="CitizenID" placeholder="Citizen ID" name="CitizenID" pattern="[0-9]{13}" required>
                        </div>
                        ...
                        <!--checkbox for user to check if he accepts condition (which is nothing)-->
