<?php
/*
    After submit staff form and have no problem, this file will appear to notify id and name
*/
session_start();
        ...
        <div class="row h-100 justify-content-center align-items-center">
            <div class="col-sm" style="text-align: center">
                <div class="form-group">
                    ...
                    <h1><strong>Please wait for a confirmation from the branch.</strong></h1>
